...
def X_to_param(col_names, geoboundary = [0.3, 0.6, 1, 1.5, 0.1, 0.2, -0.7854, 0.7854], out_dir='D:/Yang_MM_Absorber_ML/NA/ei_investigation/100samples_nosim_300steps_lre-2_1000guesses', rand_seed=1234):
    print('Transferring normalized X to param data...')

    # generate random parameter samples for each element
    xdata = pd.read_csv(os.path.join('D:/Yang_MM_Absorber_ML/NA/ei_investigation/100samples_nosim_300steps_lre-2_1000guesses/test_Xpred_best_8e-5.csv'), delimiter=' ', header=None)
